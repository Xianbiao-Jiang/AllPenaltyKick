...
class UdpComms():
    ...
    def SendData2(self, strToSend, sendToIP):
        # Use this function to send string to C#
        self.udpSock.sendto(bytes(strToSend,'utf-8'), sendToIP)
...
#            data, _ = self.udpSock.recvfrom(1024)
            ...
            data, self.clientIP = self.udpSock.recvfrom(1024)
